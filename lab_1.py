...
def window2():
    ...
    win2_elem_a1_label.grid(row=1, column=0)
    win2_elem_a_label = Label(win2, text='')
    win2_elem_a_label.grid(row=1, column=1, sticky='w', padx=10)
    win2_elem_b1_label = Label(win2, text='Множина B:')
    win2_elem_b1_label.grid(row=2, column=0)

    win2_elem_b_label = Label(win2, text='')
    win2_elem_b_label.grid(row=2, column=1, sticky='w', padx=10)
    win2_elem_c1_label = Label(win2, text='Множина C:')
    win2_elem_c1_label.grid(row=3, column=0)
    win2_elem_c_label = Label(win2, text='')
    win2_elem_c_label.grid(row=3, column=1, sticky='w', padx=10)
